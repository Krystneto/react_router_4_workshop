...
class Home extends Component {    
  ...
  handleSubmit = (e) => {
    e.preventDefault();
    let teacherName = e.target.name.value;
    let teacherTopic = e.target.topic.value;
    ...
    return (
      <div className="main-content home">
        ...
        <form onSubmit={this.handleSubmit}>
          <input type="text" placeholder="Name" name="name" value={this.name} />
          <input type="text" placeholder="Topic" name="topic" value={this.topic} />
